          ...
          >
            <div id="top-card">
              <div
                ref={backgroundRef}
                role="button"
                className="bg-[url('https://res.cloudinary.com/vietnamenglishcore/image/upload/v1700141954/fe2ce513-512b-42d0-b1c7-68a2d4758b9c.webp')] aspect-[3.5] bg-[#ebeced] dark:bg-[#333537] overflow-hidden transition-all duration-300 ease-in-out relative cursor-pointer"
              >
                {/* <Input
                  value={calendarReq.cover}
                  onChange={(e) =>
                    setCalendarReq({ ...calendarReq, cover: e.target.value })
                  }
                ...
                <div
                  id="overlay animated"
                  className="hover:bg-gray-300 absolute top-0 left-0 right-0 bottom-0 bg-transparent transition-all duration-300 ease-in-out"
                ></div>
                <div
                  id="animated image"
                ...
                >
                  <div>
                    ...
                    >
                      ...
                      <div
                        id="avatar square"
                        className="w-[64px] h-[64px] rounded-[0.5rem] bg-center bg-cover flex justify-center items-center bg-[#ebeced] dark:bg-[#333537]"
                      >
                        <Avatar
                          radius="full"
