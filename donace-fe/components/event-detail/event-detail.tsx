                                    ...
                                    <div className="top-card-content">
                                        <div className="spread gap-2 mb-4 flex justify-between items-start">
                                            <div className="min-w-0">
                                                <h1 className="text-4xl font-sans break-words text-[#fff] mb-0 font-semibold mt-0">{eventDetail.name}</h1>
                                                <div className="host mt-2">
                                                    <div className="text-tinted text-[hsla(0,0%,100%,.79)] gap-2 flex items-center">
                                                        <div className="flex items-center">
                                                            <Avatar radius="full"
                                                                src={userProfile?.result.avatar.trim() ? userProfile?.result.avatar : 'https://avatars.githubusercontent.com/u/88397960?v=4'}
                                                                name="Donace"
                                            ...
                                            <div className="calendar-card w-16 rounded-lg overflow-hidden border border-solid border-[rgba(255,255,255,0.08)] text-[#fff] text-center min-h-full flex-shrink-0">
                                                <div className="month text-sm p-[0.25rem_0] font-semibold uppercase tracking-[0.5px]">{ConvertDateTime(eventDetail.startDate).month}</div>
                                                <div className="day text-3xl p-2 pt-1.5 bg-[rgba(255,255,255,0.08)] font-medium">{ConvertDateTime(eventDetail.startDate).day}</div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div className="icon-row gap-4 flex items-center">
                                                        <div className="icon-container w-10 h-10 border border-solid border-[rgba(255,255,255,0.08)] text-[hsla(0,0%,100%,.79)] m-[0.125rem_0] flex-shrink-0 justify-center flex items-center overflow-hidden rounded-lg">
                                                            <div className="calendar-card w-full text-center min-h-full">
                                                                <div className="month bg-[rgba(255,255,255,0.08)] text-xs font-semibold uppercase p-0.5">{ConvertDateTime(eventDetail.startDate).month}</div>
                                                                ...
                                                                <div className="spread mt-1 flex justify-between items-start">
                                                                    <div className="avatar-wrapper">
                                                                        <Avatar
                                                                            src={userProfile?.result.avatar.trim() ? userProfile?.result.avatar : 'https://avatars.githubusercontent.com/u/88397960?v=4'}
                                                                            name="Donace"
                                                                            className="w-10 h-10 bg-center bg-cover relative"
                                                                            radius="full" />
                                                                    </div>
                                                                </div>
