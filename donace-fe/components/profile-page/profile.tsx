    ...
    return (
        <div className="page-content">
            <div className="profile-page-theme font-sans font-normal">
                {userProfile && userProfile.result && Array.isArray(userProfile.result) ? (
                    userProfile.result.map((user, index) => (
                        <div key={index}>
                                                ...
                                                <div className="bio-container">
                                                    <div className="user-header-text">
                                                        <Link className="text-inherit transition-all duration-300 ease-in-out cursor-pointer" underline="none">
                                                            <h1 className="font-semibold text-3xl mt-4 mb-4">{user.userName}</h1>
                                                        </Link>
                                                    </div>
                    ...
                    <div className="flex justify-center items-center text-red-500">khong hien thi</div>
                )}
            </div>
        </div>
    )
